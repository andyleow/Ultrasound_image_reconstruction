...
elseif ispc
    ...
    mex -largeArrayDims -f src/gpuFBF/nvcc_msvcpp2015.xml NVCC_FLAGS="" -v src/gpuFBF/cuFBF_single.cu src/gpuFBF/cuFBF_functionV1.cu -output src/gpuFBF/cuFBF_int
    mex -largeArrayDims -f src/gpuFBF/nvcc_msvcpp2015.xml NVCC_FLAGS="" -v src/gpuFBF/cuFBF_single.cu src/gpuFBF/cuFBF_functionV1.cu -output src/gpuFBF/cuFBF_single    
else
