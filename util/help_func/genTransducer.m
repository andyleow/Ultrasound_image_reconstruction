...
switch code
    case 'L22-14v'
		...
		Trans.kerf = 0.002e-3;
		Trans.position = [linspace(-63.5, 63.5, Trans.numElement)*Trans.pitch; zeros(1,Trans.numElement)]';
    ...
    case 'L7-4'
      ...
      case 'L12-3v'
		...
		Trans.width = 0.17e-3;
		Trans.kerf = 0.03e-3;
		Trans.position = [linspace(-95.5, 95.5, Trans.numElement)*Trans.pitch; zeros(1,Trans.numElement)]';
    ...
    case 'L12-5 50mm'
        ...
        Trans.width = .1703e-3;
        Trans.kerf = 0.025e-3;
        Trans.position = [linspace(-127.5, 127.5, Trans.numElement)*Trans.pitch; zeros(1,Trans.numElement)]';
        Trans.lensCorrection=2.365e-3;
        Trans.bw = [5 12]*1e6;
...
% 		transducer.kerf = 0.048e-3;
    Trans.position = linspace(-47.5, 47.5, Trans.numElement)*Trans.pitch;
