...
%DAS GPU beamforming adapted in external function
...
% addpath(genpath('/home/chleow/git-repo/Ultrasound_image_reconstruction/examples'));
...
PData.PDelta = [Trans.spacing, 0, 0.5]; %x,y,z
PData.Size(1) = ceil(sampleDepthWL)/PData.PDelta(3); % startDepth, endDepth and pdelta set PData.Size.
PData.Size(2)=ceil((Resource.Parameters.numRcvChannels*Trans.spacing)/PData.PDelta(1));
...
TX = repmat(struct('waveform', 1, ...
                   ...
                   'focus', UserSet.TXFocusMM*1e-3/wavelength, ...
                   'Steer', [0.0,0.0], ...
...
save('MatFiles/L22-14v_FlashAngles_GPU_DAS');
filename='L22-14v_FlashAngles_GPU_DAS'; VSX;
return
